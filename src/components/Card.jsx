...
export default function Card(props) {
  ...
  return (
    ...
    <div onClick={()=>{history.push(`/${label}`)}}  className=" flex flex-wrap  max-w-sm m-2  mx-20  shadow-2xl mb-8 rounded-2xl hover:scale-105 hover:shadow-2xl transform duration-500 cursor-pointer">
